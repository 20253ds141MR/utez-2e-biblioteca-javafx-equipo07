...
Consulta: Visualización del catálogo completo en tabla interactiva.
...
Cada integrante trabaja y hace commits en su rama personal.
Cuando una parte funciona, se hace merge a dev y se resuelven conflictos.
Se prueba que todo corra correctamente en dev.
Al finalizar, se hace merge de dev a main para la entrega.
